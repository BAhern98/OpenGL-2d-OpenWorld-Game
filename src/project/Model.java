...
public class Model {
	...
	public Model(float[] vertices, float[] tex_coords, int[] indices) {
		...
		v_id = glGenBuffers();//generatig id for variable
		glBindBuffer(GL_ARRAY_BUFFER, v_id);//binds id to buffer
		glBufferData(GL_ARRAY_BUFFER, createBuffer(vertices), GL_STATIC_DRAW);//passes data to buffer
