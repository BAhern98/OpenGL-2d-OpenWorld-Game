...
public class TileRenderer {
	...
	public TileRenderer() {
		...
		float[] texture = new float[] { 0, 0, // top left 0
				1, 0, // top right 1
				1, 1, // bottom right 2
				0, 1, // bottom left 3
		...
		int[] indices = new int[] { 0, 1, 2, // top left, top right, bottom right
				2, 3, 0,// bottom right, bottom left and rop left
		};
	...
	public void renderTile(Tile tile, int x, int y, Shader shader, Matrix4f world, Camera camera) {
		...
		camera.getprojection().mul(world, target);// get camera projection and multiplying with world and input it into
												// target
